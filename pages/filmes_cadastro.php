    ...
    <a href = "index.php?pagina=filmes_listar"> Lista de filmes </a>
        ...
        <form action = "index.php?pagina=filmes_cadastro_salvar" method = "POST">
            ...
            <input type = "number" name = "ano_lancamento" required placeholder = "Digite o ano de lançamento do filme"><br>
            ...
            <input type = "number" name = "classificacao" required placeholder = "Digite a classificação do filme"><br>
